...
const CreatePost = () => {
  ...
  return (
    ...
    <h1 className='font-bold md:text-4xl text-2xl pt-8 '>Create a post</h1>
    </div>
        ...
        <form className='w-full flex flex-col space-y-4 md:space-y-8 mt-4 p-6 rounded-md bg-gray-100 shadow-xl shadow-black'>
          ...
          />
          <input onChange={(e) => setFile(e.target.files[0])} type='file' className='px-4 py-2 border-2	 border rounded-md' />
          ...
          <div className='flex flex-col bg-white p-4 rounded-md border-2	'>
            <div className='flex items-center space-x-4 md:space-x-8 '>
              ...
              <div
                onClick={addCategory}
                className='bg-black text-white px-4 py-2 font-semibold cursor-pointer rounded-md border-2	border-2	border-2	 '
              >
                Add
              </div>
            </div>
