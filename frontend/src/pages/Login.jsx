...
<div className="w-full flex justify-center items-center h-[80vh] bg-sky-700 shadow-xl	">
       <div className="flex flex-col justify-center items-center space-y-4 w-[80%] md:w-[25%] bg-white p-8 rounded-lg shadow-xl shadow-black		">
         ...
         <button onClick={handleLogin} className="w-full px-4 py-4 text-lg font-bold text-white bg-black rounded-lg hover:bg-gray-500 hover:text-black transition duration-1000 ">Log in</button>
